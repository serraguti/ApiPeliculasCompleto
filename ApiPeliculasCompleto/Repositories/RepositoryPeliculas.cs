...
namespace ApiPeliculasCompleto.Repositories
{
    public class RepositoryPeliculas
    {
        ...
        {
            return this.context.Peliculas.SingleOrDefault(z => z.IdPelicula == id);
        }

        public Cliente FindCliente(int id)
        {
            return this.context.Clientes.SingleOrDefault(x => x.IdCliente == id);
        }
        ...
        public void AddPedido(int idcliente, int idpelicula
            , int cantidad, DateTime fecha, int precio)
        {
